...
### Chart 2 Description
- This chart is mean to show the average brightness temperatures of the Australian fires in the beginning of 2020. This is important as it can later be compared to fires in the past. This comparison can lead to a conclusion about whether or not global warming and the brightness temperatuers of Australian wildfires are correlated.
```{r echo=FALSE}
  fire_chart_final
```
